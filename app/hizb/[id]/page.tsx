...
export default function HizbDetailPage() {
  ...
  useEffect(() => {
    async function loadHizb() {
      try {
        ...
        const [arabicData, translationData] = await Promise.all([
          getHizbQuarterWithOffset(hizbNumber, reciterEdition),
          getHizbQuarterWithOffset(hizbNumber, selectedEdition),
        ]);
    ...
    loadHizb();
  }, [hizbNumber, selectedEdition, reciterEdition]);
